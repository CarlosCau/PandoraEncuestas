...
<html>
    <head>
        ...
        ?>
        <script src="js/logicasCuestionario_v1.js"></script>
    </head>
    <body  onload="Startpage()">
        ...
        <div id="principal" class="container-fluid main">
            <nav class="navbar fixed-top navbar-light bg_red fuenteBlanca">
                ...
                <div class="collapse navbar-collapse borde" id="navbarNavAltMarkup">
                    ...
                    <div class="col-sm-12 col-lg-4 datosUsuario borde">
                        <div class="row">
                            ...
                            <div class="col-sm-12 col-lg-10 borde">
                                <input id="idUsuario" type="hidden" class="form-control form-control-sm datosUpaxer" value="<? echo $_SESSION["id_usuario"]; ?>">
                                <input id="nomUsuario" type="hidden" class="form-control form-control-sm datosUpaxer" value="<? echo $_SESSION["nombre"]; ?>">
                                <div class="col-sm-12 col-lg-12">
                                    <div class="datos_usuario"><? echo $_SESSION["id_usuario"]; ?></div>
                                </div>
                                <div class="col-sm-12 col-lg-12">
                                    <div class="datos_usuario"><? echo $_SESSION["nombre"]; ?></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-sm-12 col-lg-8 borde">
                        <div class="navbar-nav derecho borde">
                            ...
                            <input id="numUsuario" type="hidden" class="form-control form-control-sm" value="<? echo $id_usuario; ?>">
                        </div>
                    </div>
            ...
            <div class="row">
                <div id="mapa" class="col-sm-12 col-lg-12 borde">
                    ...
                    <div id="altaPunto" class="borde"><!--Capá de Captura de Punto-->
                        <input type="text" id="id_reg" class="form-control form-control-lg camposPuntos" placeholder="Id Punto">
                        
                        <input type="text" id="encuestador" class="form-control form-control-lg camposPuntos" placeholder="Encuestador">
                        
                        <input type="text" id="cometarios" class="form-control form-control-lg camposPuntos" placeholder="Comentarios">
                        
                        <input type="text" id="lat" class="form-control form-control-lg camposPuntos" placeholder="Latitud" disabled>
                        
                        <input type="text" id="long" class="form-control form-control-lg camposPuntos" placeholder="Longitud" disabled>
                ...
                <div id="cuestionario" class="col-sm-12 col-lg-12 borde"><!--Capa de Cuestionario-->
                                            ...
                                            while($resp=pg_fetch_array($resultadorespuestas)){
                                                if($tipo=="dicotomica" or $tipo=="unica"){
                                                    echo "<div class='form-check col-sm-12 col-lg-12 respContOpcion borde'>
                                                          <input id='respuesta$resp[7]' name='respuesta$resp[0]' class='form-check-input radioBtn respuesta borde' type='radio' indice='$resp[0]' value='$resp[2]' origen='$resp[4]' destino='$resp[5]' ponderador='$resp[8]'>
                    ...
                    <div class="botones borde">
                        <button id="btnGuardar" type="button" class="btn btn-primary centrado btn_ingresar oculto" value="">Guardar</button>
                    </div>
                </div>
